...
Once the paper is accepted for publication, the replication package will be posted on the journal's repository at [zenodo.org]({{< var jpe.zenodo >}}) and it will be linked with the paper. Alternative repositories may be acceptable as long as they are considered “trusted” by the journal. Submission on such online repositories indicates that the authors license users to download, copy, and modify this material. Users of the material must acknowledge all authors as the original creators and cite both the replication package and the paper accordingly.
